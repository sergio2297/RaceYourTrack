...
public class ListChallengesFragment extends Fragment {
    ...
    public ListChallengesFragment(final List<Challenge> listChallenges) {
...
//        addListenersToViewElements();
    ...
    public void onResume() {
        ...
        if(recyclerView != null) {
            recyclerView.setAdapter(new ListChallengesRecyclerViewAdapter(listChallenges, selectedChallenge));
        }
    }
    ...
    private void initializeViewElements() {
        ...
        if(recyclerViewElement instanceof RecyclerView) {
            ...
            this.recyclerView.setAdapter(new ListChallengesRecyclerViewAdapter(listChallenges, selectedChallenge));
